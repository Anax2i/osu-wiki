...
![NS mod icon](/wiki/Gameplay/Game_modifier/Lazer/Mods/NS.png "No Scope (NS) mod icon")
...
- Compatible game modes: ![][osu!] ![][osu!catch]
- Incompatible mods: None
- Status: **RANKED**

## Gameplay

![](/wiki/Gameplay/Game_modifier/Lazer/Mods/Gameplay/no_scope.gif)
